      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,1.15fr)_minmax(360px,.85fr)]">
        <div className="space-y-6">
          ...
          <Card><CardHeader><CardTitle>Billing instructions</CardTitle></CardHeader><CardContent className="space-y-5">
            ...
            {editing ? <>
              <div className="space-y-2"><Label htmlFor="edit-description" required>Billing Description</Label><Textarea id="edit-description" required value={description} onChange={(event) => setDescription(event.target.value)} /></div>
